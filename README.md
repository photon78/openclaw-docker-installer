...
|---------|--------|------------|
| **v0.3.0** | ✅ Stable | Multi-agent-ready workspace, BOOT.md, exec-approvals hygiene, shared-output, Stop-Regel, AGENTS.md vollständig |
...
**Workspace**
- ✅ Full workspace bootstrapped: `SOUL.md`, `AGENTS.md`, `HEARTBEAT.md`, `BOOT.md`, `IDENTITY.md`,
  `MEMORY.md`, `USER.md`, `BOOTSTRAP.md`, `TOOLS.md`, `scripts/check_tasks.py`
...
- ✅ `shared-output/` directory for cross-agent file delivery (Telegram, exports)
- ✅ `clean_exec_approvals.py` — weekly hygiene script (removes shell tools, deduplicates)

**Multi-Agent Ready**
- ✅ `AGENTS.md` template: Stop-Regel, Tool-Fehler-Pflicht, Edge-Case-Regeln, Delegation-Check,
  Handoff-Format, Neuer-Agent-Checkliste (8 Schritte)
- ✅ `BOOT.md`: Startup-Checkliste nach Gateway-Restart / Container-Neustart
- ✅ `maxSpawnDepth: 2` — main → subagent → research (konfiguriert, nicht zu flach)
- ✅ No silent approvals — every exec request shows full command + explanation
...
| macOS | 🔜 Planned |
| Windows 11 | 🔜 Planned (v0.3.0 test) |
...
| **v0.2.0** | The Pack | Multi-agent prep, user profile wizard, Windows compat, BOOTSTRAP |
| **v0.3.0** | Agent Ready | Multi-agent-ready workspace, AGENTS.md vollständig, BOOT.md, exec-hygiene |
| v0.4.0 | Orchestrator | Multi-agent Wizard, Template-Bibliothek (coding/research/content) |
